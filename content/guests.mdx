...
This seems extremely unlikely. The County's own FAQ states "actually staying in a home for less than 30 days is still a violation" which implies that the guest is violating the law. However, nowhere else in the law itself or in the County's publications is there any indication that the guest can be deemed to be at fault, so our interpretation is that the statement is simply careless language.
