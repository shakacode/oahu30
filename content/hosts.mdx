...
Advertising is a new violation, but actually staying in a home for less than 30 days is still a violation. The DPP will continue to monitor for occupancy violations. Also, just as a caution to homeowners, Governor David Ige recently signed House Bill No. 807 (Act 114), which makes it a misdemeanor offense to knowingly make a false statement to a county inspector. This is not something that we plan to use, but it is a tool in our enforcement toolkit. 
